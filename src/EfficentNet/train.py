...
from src.EfficentNet.dataset import SkinDataset, train_transform, val_transform
from src.EfficentNet.model import build_model
...
for epoch in range(EPOCHS):
    ...
    if val_loss < best_loss:
        best_loss = val_loss
        counter = 0
        torch.save(model.state_dict(), "models/best_EffecientNet_model.pth")
    else:
        counter += 1
